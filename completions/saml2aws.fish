...
complete --command saml2aws --short-option i --long-option provider=PROVIDER --description "This flag is obsolete. See: https://github.com/Versent/saml2aws#configuring-idp-accounts"
...
complete --command saml2aws --short-option -a --long-option idp-account="default" --description "The name of the configured IDP account. (env: SAML2AWS_IDP_ACCOUNT)"
...
complete --command saml2aws --short-option -s --long-option skip-verify --description "Skip verification of server certificate. (env: SAML2AWS_SKIP_VERIFY)"
...
complete --command saml2aws --short-option -r --long-option region=REGION --require-parameter --description "AWS region to use for API requests, e.g. us-east-1, us-gov-west-1, cn-north-1 (env: SAML2AWS_REGION)"
